...
function getprogram(program) {
    ...
    const url = "https://powerful-stream-32762.herokuapp.com/api/v1/programs/getProgram"
...
async function get_course(course) {
    const url = "https://powerful-stream-32762.herokuapp.com/api/v1/programs/getCourse"
    const request = new Request(url, {
        method: 'POST',
